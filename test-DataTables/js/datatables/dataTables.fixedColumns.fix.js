...
(function (factory) {
    ...
    $.extend(FixedColumns.prototype, {
        ...
        "_fnConstruct": function (oInit) {
            ...
            jqTable
                ...
                .on('destroy.dt.DTFC', function () {
                    ...
                    //$(this.s.dt.nTableWrapper).off('.DTFC'); // ------------- xy
        ...
        "_fnColCalc": function () {
            ...
            $.each(this.s.dt.aoColumns, function (i, col) {
                ...
                if (!th.filter(':visible').length) {
                    ...
                    if (that.s.aiOuterWidths.length === 0) {
                        ...
                        //iWidth += typeof border === 'string' ? 1 : parseInt(border, 10); // n px ---> 1
                        iWidth += parseInt(border);// xy
                    }
            ...
            // both .DTFC_LeftWrapper, .DTFC_RightWrapper have left & right table-border ----- xy
            this.s.iLeftWidth += parseInt($(that.s.dt.nTable).css('border-right-width'));
            this.s.iRightWidth +=  parseInt($(that.s.dt.nTable).css('border-left-width'));
        },
        ...
        "_fnGridSetup": function () {
            ...
            if (this.s.iRightColumns > 0) {
                ...
                if (oOverflow.y) // ------ do not add bar-width without y-scollbar --- xy
